...
public class SlopCrewScrollView : PhoneScroll {
    private float buttonSpacing = 45.0f;
    private float buttonTopMargin = -120.0f;
    ...
    private void LoadSprites() {
        var phoneSheet = TextureLoader.LoadResourceAsTexture("SlopCrew.Plugin.res.phone_app_sheet.png", 1024, 1024, false);
    ...
    private void CreatePrefabs(GameObject arrowObject, TextMeshProUGUI titleObject) {
        ...
        confirmArrow.transform.localPosition = new Vector2(scaledButtonSize.x - scaledButtonSize.x * 0.1f, scaledButtonSize.y - scaledButtonSize.y * 0.1f);
